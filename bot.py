...
async def op(_, m :Message):
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            ...
            await m.reply_photo(
                "https://telegra.ph/file/a782e3bbbe40df8a4bb67.jpg",
        ...
        print(f"{m.from_user.first_name} Is started Your Bot!")
        ...
        await m.reply_text(
            f"**⚠️Access Denied!⚠️\n\nPlease Join @{cfg.FSUB} to use me.If you joined click check again button to confirm.**",
            reply_markup=key,
        )
...
async def chk(_, cb : CallbackQuery):
    try:
        ...
        print(f"{cb.from_user.first_name} Is started Your Bot!")
    except UserNotParticipant:
